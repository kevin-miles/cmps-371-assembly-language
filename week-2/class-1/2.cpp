//----------------------------------------------------------------------
// Purpose: This program takes the name and sex of an input given by the
// user and then repeats the proper greeting and name back to request the 
// age. The age again given by the user and the cost of the membership is 
// printed as output.
//----------------------------------------------------------------------
#include <iostream>
#include <iomanip>
